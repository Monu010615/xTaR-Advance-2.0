...
async def run_batch(userbot, client, sender, countdown, link):
    ...
    for chunk in chunks:
        ...
        if processed_ids % batch_size == 0:
            ...
            await countdown.edit(f"**Batch process ongoing...**\n\nProcessed: {processed_ids} Links", buttons=[[Button.url("Join Channel", url="https://t.me/xTaR_Main")]])
...
# variables
API_ID = "21617866" #config("API_ID", default=None, cast=int)
API_HASH = "fae6ca0bec0ddfce29fa6d75d7c61c90" #config("API_HASH", default=None)
BOT_TOKEN = "{bot_token}"
SESSION = "{session}"
FORCESUB = "save_restricted_content_bots" #config("FORCESUB", default=None)
AUTH = "7270470326" #config("AUTH", default=None)
SUDO_USERS = []
...
API_ID = 21617866
API_HASH = "fae6ca0bec0ddfce29fa6d75d7c61c90"
